...
// date 20130817_1558
//commit modify some parameter

// /////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Transform Utilities.
//
// This window contains four useful tools for asset placing and manipulation: 
// Align, Copy, Randomize and Add noise.
//
// Put this into Assets/Editor and once compiled by Unity you find
// the new functionality in Window -> TransformUtilities, 
// or simply press Ctrl+t (Cmd+t for Mac users)
// 
...
public class TransformUtilitiesWindow : EditorWindow 
{
	...
	/// </summary>
    [MenuItem("Batch/TransformUtilities %t")]
    static void Init() 
	{
